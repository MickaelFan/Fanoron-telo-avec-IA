...
| --------------------------------------- | ----------------- | ------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| RAVELONARIVO Fanantenana Mickaël        | N°26              | ESIIA4 | **Lead Développeur & Moteur IA** — Conception et implémentation du Minimax avec élagage alpha-bêta, table de transposition et fonction d'évaluation heuristique (`gameLogic.js`) |
